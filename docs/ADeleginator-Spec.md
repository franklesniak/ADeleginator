...
| **Required placement** | By default, `ADeleg.exe` must be placed in the same directory as ADeleginator. Alternatively, the user can specify a custom path via the `PathToADeleg` input parameter. |
